...
function onEvent(name, value1, value2)
    if name == 'TextEvent' then
        --Set text stuff
        makeLuaText('text1', value1, 600, 350, 350);--First value - tag. Second - text to write. Third - text width. Fourth - X value. Last - Y value
        ...
        setTextBorder('text1', 1, 0x000000);--Sets text border weight and color
        setTextColor('text1', '0xff0000');--This and the function above work like freeplaySonglist.txt
