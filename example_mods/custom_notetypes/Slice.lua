...
function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		...
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'Bullet Note' then
			...
			setPropertyFromGroup('unspawnNotes', i, 'missHealth', 100.0); --Change amount of health to take when you miss like a fucking moron
...
dodgeAnimations = {'idleLEFT', 'idleDOWN', 'idleUP', 'idleRIGHT'}
